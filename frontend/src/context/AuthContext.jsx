...
export const AuthProvider = ({ children }) => {
  ...
  return (
    <AuthContext.Provider value={{ user, token, loading, error, login, googleLogin, register, verifyEmail, resendVerification, forgotPassword, resetPassword, logout, updateProfile, setError, fetchUserProfile }}>
      {children}
