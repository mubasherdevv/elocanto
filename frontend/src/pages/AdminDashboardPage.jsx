...
export default function AdminDashboardPage() {
  ...
  const stats = [
    { label: 'Total Users', value: data?.stats.totalUsers || 0, icon: UsersIcon, color: 'text-blue-600', bg: 'bg-blue-50', path: '/admin/users' },
    { label: 'Total Ads', value: data?.stats.totalAds || 0, icon: TagIcon, color: 'text-orange-600', bg: 'bg-orange-50', path: '/admin/ads' },
    { label: 'Pending Ads', value: data?.stats.pendingAds || 0, icon: PauseCircleIcon, color: 'text-purple-600', bg: 'bg-purple-50', path: '/admin/ads?filterApproval=pending' },
    { label: 'Featured Ads', value: data?.stats.featuredAds || 0, icon: StarIcon, color: 'text-yellow-600', bg: 'bg-yellow-50', path: '/admin/ads?listingType=featured' },
    { label: 'Gallery Ads', value: data?.stats.galleryAds || 0, icon: SparklesIcon, color: 'text-emerald-600', bg: 'bg-emerald-50', path: '/admin/ads?listingType=gallery' },
  ];
