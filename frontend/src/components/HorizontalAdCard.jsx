  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12 }}>
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8, background: 'var(--gray-50)', padding: '4px 10px', borderRadius: 8, width: 'fit-content' }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 800, color: 'var(--gray-500)', textTransform: 'uppercase', letterSpacing: 0.5 }}>{ad.seller?.name || 'Seller'}</span>
            </div>
        ...
        <div style={{ display: 'flex', gap: 16, color: 'var(--gray-600)', fontSize: 12, fontWeight: 500, marginBottom: 12 }}>
        ...
        <p style={{ fontSize: 13, color: 'var(--gray-600)', lineHeight: 1.5, marginBottom: 16, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
          {ad.description || 'Premium full-frame photography kit including professional lens, weather-sealed body, and original accessories...'}
        </p>
