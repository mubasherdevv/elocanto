...
export const trackBulkViews = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Failed to track views' });
  }
};

export const getAdViews = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Failed to get views', error: error.message });
  }
};
